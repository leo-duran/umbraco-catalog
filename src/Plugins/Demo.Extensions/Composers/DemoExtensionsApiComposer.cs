...
namespace Demo.Extensions.Composers
{
    public class DemoExtensionsApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Demo Extensions Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<DemoExtensionsOperationSecurityFilter>();
            });
        }

        public class DemoExtensionsOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Demo.Extensions.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
