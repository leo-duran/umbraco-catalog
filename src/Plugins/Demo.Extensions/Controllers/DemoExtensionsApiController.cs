...
namespace Demo.Extensions.Controllers
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "Demo.Extensions")]
    public class DemoExtensionsApiController : DemoExtensionsApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public DemoExtensionsApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
