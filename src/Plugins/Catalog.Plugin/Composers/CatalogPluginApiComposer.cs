...
{
    public class CatalogPluginApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Catalog Plugin Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<CatalogPluginOperationSecurityFilter>();
            });
        }

        public class CatalogPluginOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Catalog.Plugin.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
